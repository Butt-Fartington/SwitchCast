...
constexpr const char* WindowTitle = "SwitchCast";
...
static bool ImguiInit()
{
	...
	colors[ImGuiCol_WindowBg] = ImVec4(0.03f, 0.05f, 0.17f, 1.0f);
	colors[ImGuiCol_ChildBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	colors[ImGuiCol_PopupBg] = ImVec4(0.08f, 0.08f, 0.08f, 0.94f);
	colors[ImGuiCol_Border] = ImVec4(0.00f, 0.73f, 1.00f, 0.62f);
	colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	colors[ImGuiCol_FrameBg] = ImVec4(0.08f, 0.11f, 0.26f, 1.0f);
	colors[ImGuiCol_FrameBgHovered] = ImVec4(0.00f, 0.68f, 1.00f, 0.52f);
	colors[ImGuiCol_FrameBgActive] = ImVec4(1.00f, 0.27f, 0.28f, 0.72f);
	...
	colors[ImGuiCol_CheckMark] = ImVec4(0.00f, 0.78f, 1.00f, 1.00f);
	colors[ImGuiCol_SliderGrab] = ImVec4(0.24f, 0.52f, 0.88f, 1.00f);
	colors[ImGuiCol_SliderGrabActive] = ImVec4(0.26f, 0.59f, 0.98f, 1.00f);
	colors[ImGuiCol_Button] = ImVec4(0.08f, 0.12f, 0.29f, 1.00f);
	colors[ImGuiCol_ButtonHovered] = ImVec4(0.00f, 0.55f, 0.90f, 0.72f);
	colors[ImGuiCol_ButtonActive] = ImVec4(1.00f, 0.27f, 0.28f, 0.82f);
	colors[ImGuiCol_Header] = ImVec4(0.00f, 0.70f, 1.00f, 0.38f);
	colors[ImGuiCol_HeaderHovered] = ImVec4(0.00f, 0.74f, 1.00f, 0.82f);
	colors[ImGuiCol_HeaderActive] = ImVec4(1.00f, 0.27f, 0.28f, 0.90f);
	...
	colors[ImGuiCol_NavHighlight] = ImVec4(0.00f, 0.78f, 1.00f, 1.00f);
